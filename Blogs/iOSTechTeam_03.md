...
3. 如果给 `category` 添加属性 `@property`，只会生成 `setter/getter` 方法的声明，并不会有具体的代码实现，详细解释可参考历史文章：[iOS 属性 @property 详细探究](https://github.com/minhechen/iOSTechTeam/blob/main/Blogs/iOSTechTeam_01.md)
